...
contract FinaMaster is Ownable {
    ...
    // The block number when FINA mining starts.
    ...
    // Update the given pool's FINA allocation point. Can only be called by the owner.
    function set(
        uint256 _pid,
        uint256 _allocPoint,
        bool _withUpdate
    ...
    // Deposit LP tokens to FinaMaster for FINA allocation.
