...
contract FinaJuniorMasterV2 is BoringOwnable, BoringBatchable {
    ...
    /// @param _finaPerSecond The amount of Fina to be distributed per second.
    function setFinaPerSecond(uint256 _finaPerSecond) public onlyOwner {
        finaPerSecond = _finaPerSecond;
        emit LogFinaPerSecond(_finaPerSecond);
    }
